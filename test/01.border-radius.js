...
describe('comapact', () => {
    ...
    describe('border-radius length', () => {
        it('should compact same values as one', function () {
            borderRadius({
        ...
        it('should compact mirrored values', function () {
            borderRadius({
        ...
        it('should fill missed values', function () {
            borderRadius({
                'border-top-left-radius': '10px'
            }).should.eql({
    ...
    describe('border-radius length and percentage', () => {
        it('should accept space and no-space in separator', function () {
            borderRadius({
